...
from rank_correlation import (load_score, recall_k, rel_k, pearson_coef, 
                            wpearson_coef, w_kendall_metric,w_kendall_metric_mmd, kendall_metric,w_kendall_metric_energy)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-me', '--method', type=str, default='leep_g',
    ...
    p = pearson_coef(score, finetune_acc, dset)
    # tw_2 = kendall_metric(score, finetune_acc, dset)
    # tw_sfda = w_kendall_metric_mmd(score, finetune_acc, dset)
    print("Kendall  dataset:{:12s} {:12s}:{:2.3f}".format(dset, metric, p))
